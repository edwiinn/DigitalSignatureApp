...
public class DocumentActivity extends BaseActivity implements DocumentMvpView {
    ...
    protected void setUp() {
        ...
        if (this.isDocumentSigned()) setSignVisibility(View.GONE);
    ...
    public void registerSignatureImageBehaviour(){
        ...
        signatureImage.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Log.d("hello", "onTouch() called with: v = [" + v + "], event = [" + event + "]");
    ...
    public void signDocumentWithElectronicSignature() {
        ...
        Log.d("Hello", "x: " + (float) signaturePoint.getX() + "Y: " + (float) signaturePoint.getY() + "Width: " + signatureImage.getWidth() * xScale + "Height: " + signatureImage.getHeight() * yScale);
